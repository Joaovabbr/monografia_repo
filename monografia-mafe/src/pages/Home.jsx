...
`}
        ...
        <div className="info-card small">
          <p>
            ...
            Após a confirmação deste termo, será enviado uma cópia do TCLE para o email colocado no espaço abaixo.
          </p>
        </div>
      </section>
